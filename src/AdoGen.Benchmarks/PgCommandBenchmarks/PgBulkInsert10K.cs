...
[BenchmarkCategory(nameof(PgBulkInsert10K))]
public class PgBulkInsert10K : PgTestBase
{
    private List<User> _users = null!;
    private List<UserModel> _userModels = null!;
    private readonly UserNpgsqlBulk _bulk = new(10_000);
    private NpgsqlTransaction _transaction = null!;

    protected override async ValueTask Initialize()
    {
        _users = UserFaker.Generate(10_000);
