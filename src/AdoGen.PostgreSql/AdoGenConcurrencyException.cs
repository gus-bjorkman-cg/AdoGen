...
{
    /// <summary>
    /// The schema-qualified table name (e.g. <c>public.Orders</c>) where the conflict occurred.
    /// </summary>
    public string TableName { get; }

    /// <param name="tableName">Schema-qualified table name, e.g. <c>public.Orders</c>.</param>
