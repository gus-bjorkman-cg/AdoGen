...
public sealed class PatchTests : TestBase
{
    public PatchTests(TestContext testContext) : base(testContext) { }
    ...
    [Fact]
    public async Task Patch_ShouldThrowNpgsqlException_WhenCommandTimeoutIsReached()
    {
        // Arrange
