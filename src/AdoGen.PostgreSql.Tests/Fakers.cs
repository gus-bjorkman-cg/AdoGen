...
public static class Fakers
{
    ...
    /// <summary>
    /// PostgreSQL TIMESTAMP has microsecond precision (6 digits).
    /// .NET DateTime has tick precision (7 digits). Truncate to avoid comparison mismatches.
    /// </summary>
    ...
    public static readonly Faker<AuditEvent> AuditEventFaker = new Faker<AuditEvent>()
        ...
        .RuleFor(x => x.CreatedAt, f => TruncateToMicroseconds(f.Date.RecentOffset().ToUniversalTime()))
    ...
    public static readonly Faker<TestType> TestTypeFaker = new Faker<TestType>()
        ...
        .RuleFor(x => x.DateTime, f => TruncateToMicroseconds(f.Date.Recent()))
        .RuleFor(x => x.NullableDateTime, f => TruncateToMicroseconds(f.Date.Recent()))
