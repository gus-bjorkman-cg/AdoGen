...
//     {
//         var (result, diagnostics) = Source.RunGenerator(AdoGenType.SqlBulkModel);
//         
...
//     {
//         var (result, diagnostics) = AdoGenType.NpgsqlBulkModel.UserSource.RunGenerator(AdoGenType.NpgsqlBulkModel);
//         if (diagnostics.Length > 0)
//         {
//             var formatted = string.Join(Environment.NewLine, diagnostics.Select(d => d.ToString()));
//             Assert.Fail("No sources were generated.\nDiagnostics:\n" + formatted);
